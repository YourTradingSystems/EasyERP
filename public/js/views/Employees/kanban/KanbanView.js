define([
        'text!templates/Employees/kanban/WorkflowsTemplate.html',
        'collections/Workflows/WorkflowsCollection',
        'views/Employees/kanban/KanbanItemView',
        'views/Employees/EditView',
        'views/Employees/CreateView'
],
function (WorkflowsTemplate, WorkflowsCollection, EmployeesKanbanItemView, EditView, CreateView) {
    var EmployeeKanbanView = Backbone.View.extend({
        el: '#content-holder',
        events: {
            "click #showMore": "showMore",
            "dblclick .employee-header, .employee-content": "gotoEditForm",
            "click .employee-header, .employee-content": "selectItem"
        },
        initialize: function (options) {Employee
            this.workflowsCollection = new WorkflowsCollection({ id: 'Employee' });
        ...
        showMoreContent: function (newModels) {
            ...
            _.each(workflows, function (workflow, i) {
                ...
                _.each(modelByWorkflows, function (wfModel) {
                    kanbanItemView = new EmployeesKanbanItemView({ model: wfModel });
